...
void MainWindow::createViewMenu()
{
  ...
  connect(_resetViewAction, &QAction::triggered, this, [this]() {
    if (_platerWidget) _platerWidget->resetCamera();
  });
  ...
  connect(_fitViewAction, &QAction::triggered, this, [this]() {
    if (_platerWidget) _platerWidget->fitAll();
  });
  ...
  connect(_topViewAction, &QAction::triggered, this, [this]() {
    if (_platerWidget) _platerWidget->setViewType(static_cast<int>(ViewType::Top));
  });
  ...
  connect(_bottomViewAction, &QAction::triggered, this, [this]() {
    if (_platerWidget) _platerWidget->setViewType(static_cast<int>(ViewType::Bottom));
  });
  ...
  connect(_frontViewAction, &QAction::triggered, this, [this]() {
    if (_platerWidget) _platerWidget->setViewType(static_cast<int>(ViewType::Front));
  });
  ...
  connect(_leftViewAction, &QAction::triggered, this, [this]() {
    if (_platerWidget) _platerWidget->setViewType(static_cast<int>(ViewType::Left));
  });
  ...
  connect(_rightViewAction, &QAction::triggered, this, [this]() {
    if (_platerWidget) _platerWidget->setViewType(static_cast<int>(ViewType::Right));
  });
  ...
  connect(_perspectiveViewAction, &QAction::triggered, this, [this]() {
    if (_platerWidget) _platerWidget->setViewType(static_cast<int>(ViewType::Perspective));
  });
...
void MainWindow::createToolsMenu()
{
  ...
  connect(_generateSupportAction, &QAction::triggered, this, [this]() {
    if (_platerWidget) _platerWidget->generateSupport();
  });
  ...
  connect(_removeSupportAction, &QAction::triggered, this, [this]() {
    if (_platerWidget) _platerWidget->removeSupport();
  });
  ...
  connect(_autoLayoutAction, &QAction::triggered, this, [this]() {
    if (_platerWidget) _platerWidget->autoLayout();
  });
  ...
  */
  ...
  connect(_previewAction, &QAction::triggered, this, [this]() {
    if (_platerWidget) _platerWidget->previewPrint();
  });
  ...
  connect(_exportGCodeAction, &QAction::triggered, this, [this]() {
    if (_platerWidget) _platerWidget->generateGCode();
  });
...
void MainWindow::onImportFile()
{
  ...
  if (!fileName.isEmpty())
  {
    ...
    if (result.success)
    {
      ...
      SceneObjectV2* sceneObj = new SceneObjectV2(
      ...
      switch (fileType)
      {
        case FileType::STL: metadata.fileType = "STL"; break;
        case FileType::OBJ: metadata.fileType = "OBJ"; break;
        case FileType::PLY: metadata.fileType = "PLY"; break;
        case FileType::THREE: metadata.fileType = "3MF"; break;
        case FileType::AMF: metadata.fileType = "AMF"; break;
        case FileType::IMAGE: metadata.fileType = "Image"; break;
        default: metadata.fileType = "Unknown"; break;
      }
...
void MainWindow::onNewProject()
{
  ...
  {
    QMessageBox::StandardButton reply = QMessageBox::question(this, "新建项目", 
      "当前项目尚未保存，是否继续？", 
